...
_Generated 2026-05-27T13:38:50.672Z_ · source: `/tmp/cfg-1h-v3.json (live DB)` (fetched 2026-05-27)
...
| source | /tmp/cfg-1h-v3.json (live DB) |
| enabled | true |
| strategy | echo |
...
| dca_body3_min_idle | 1500 |
| dca_body3_min_armed | 1200 |
| echo_dca_scale | [2] |
